...
# string.Formatter().parse(self.template) returns a generator of tuples with 4 elements:
# literal_text - text before the placeholder
# field_name - the placeholder name (e.g., "context", "question")
# format_spec - format specification (usually empty)
# conversion - conversion type (usually None)
...
PROMPT_REGISTRY: Dict[PromptType, PromptTemplate] = {
    PromptType.PRODUCT_BOT: PromptTemplate(
        ...
        Keep your response grounded to the context and avoid making up information.
        ...
        YOUR ANSWER:
        """,
        description="Handles ecommerce product recommendation flows"
    )
}