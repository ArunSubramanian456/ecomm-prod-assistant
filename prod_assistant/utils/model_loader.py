...
class ModelLoader:
    ...
    def load_embeddings(self):
        ...
        try:
            ...
            # The GoogleGenerativeAIEmbeddings uses gRPC with async I/O under the hood.
            # This patch ensures that when GoogleGenerativeAIEmbeddings is instantiated, 
            # it has a proper event loop to work with, preventing runtime errors related to missing async context.
            try:
